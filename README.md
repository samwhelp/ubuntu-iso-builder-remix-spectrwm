...
# ubuntu-iso-builder-remix-spectrwm
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-spectrwm](https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-spectrwm.git
```


> change dir to `ubuntu-iso-builder-remix-spectrwm`

``` sh
cd ubuntu-iso-builder-remix-spectrwm
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-spectrwm/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-spectrwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-spectrwm/iso-profile/dist`
